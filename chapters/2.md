...
<Image - Language Selection Screen Monero GUI >
...
< WELCOME SCREEN: NEW OR RESTORE FIGURE >
...
< UNLOCK WALLET FIGURE >

### Receiving Monero

The “Receive” tab of the Monoro GUI contains both the text and QR-code forms of your receiving addresses. The “Create new address” button generates as more “subaddresses,” which will all direct to this same wallet (seed). You can indicate an “Amount to receive,” which will be encoded into the QR code.

< RECEIVE MONERO GUI FIGURE >
