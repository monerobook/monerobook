...
A view-only wallet is a special wallet which contains the private view key in order to see a sum of all transactions received and sent. This can be helpful and useful for people who want to add trasparency by permetting to others to see partially their transactions.
