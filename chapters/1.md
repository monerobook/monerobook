...
Similar to almost every cryptocurrency, The Monero Team has released Monero as open source: the project code is online for review, and anyone can propose changes.  The developers are transparent in their work by releasing meeting logs and regular development and research updates.  A lack of transparency in a development team is a reason any ICO (Initial Coin Offering) should be avoided. In my opinion, Monero must be open source, which will lead to more trust and less problems. Do you have you doubts? There are almost one hundred tools available to check out about Monero.
