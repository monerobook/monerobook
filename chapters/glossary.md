...
Bulletproofs are a new mathematical system for verifiable masked transaction amounts. Bulletproofs shrink transaction sizes by ~80%, and thus reduce fees dramatically.
