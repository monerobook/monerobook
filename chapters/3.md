...
Each transaction within the Monero network involves working with inputs and outputs, where inputs consume Monero from the sender and outputs transfer them to the recipient.
